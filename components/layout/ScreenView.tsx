...
export const AD_HEIGHT = 61; // TODO: This would ideally be imported from the ad component

export const SCREEN_HEIGHT = Dimensions.get("screen").height - (HEADER_HEIGHT + TAB_BAR_HEIGHT + AD_HEIGHT + 20);
